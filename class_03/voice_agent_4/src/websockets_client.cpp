...
namespace websockets {
    ...
    void WebsocketsClient::upgradeToSecuredConnection() {
        ...
        } /*fix starts here */ else {
            // Udi, 2026-04-02: fix - ESP32 branch was missing setInsecure() fallback.
            // Unlike ESP8266, no certs provided meant cert verification silently ran
            // with no CA bundle, causing WSS connections to always fail.
            client->setInsecure();
            // end fix
        }
    #endif
